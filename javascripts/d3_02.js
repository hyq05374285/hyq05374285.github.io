...
c4.attr('x1',x1).attr('y1',330).attr('x2',48).attr('y2',280).attr('stroke','black').attr('stroke-width',3)
var c5 =svgctrl.append('line')
c5.attr('x1',x1).attr('y1',330).attr('x2',188).attr('y2',280).attr('stroke','black').attr('stroke-width',3)
var c6 =svgctrl.append('line')
c6.attr('x1',x1).attr('y1',230).attr('x2',x1).attr('y2',400).attr('stroke','black').attr('stroke-width',3)
var c7 =svgctrl.append('line')
c7.attr('x1',x1).attr('y1',400).attr('x2',188).attr('y2',500).attr('stroke','black').attr('stroke-width',3)
var c8 =svgctrl.append('line')
c8.attr('x1',x1).attr('y1',400).attr('x2',48).attr('y2',500).attr('stroke','black').attr('stroke-width',3)
